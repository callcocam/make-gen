...
$(document).ready(function() {
    ...
    $('#add_form_properties').click(function(e){
        ...
        formTitle.css({'background-color' : '#87ffc1'}).animate({backgroundColor: '#f9f6f1'},{duration:1000});
    });
	...
	$('#single_line_text').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/input', { name: "Edit Input Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_date').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/date', { name: "Edit Date Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_number').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/number', { name: "Edit Number Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_phone').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/phone', { name: "Edit Phone Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_password').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/password', { name: "Edit Password Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_password_verify').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/passwordverify', { name: "Edit Password Verify Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_email').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/email', { name: "Edit Email Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_paragraph').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('/make/paragraph', { name: "Edit Textarea Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_checkbox').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('/make/checkbox', { name: "Edit Checkbox Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_radio').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('/make/radio', { name: "Edit Radio Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_dropdown').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('/make/dropdown', { name: "Edit Drop Down Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
    ...
    $('#line_upload').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('/make/upload', { name: "Edit Input Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_credit_card').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('/make/creditcard', { name: "Edit Credit Card Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_url').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('/make/url', { name: "Edit Web Site / Url Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_hidden').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('/make/hidden', { name: "Edit Hidden Field", id: liId}).done(function(data) {
                fieldProp.html(data);
